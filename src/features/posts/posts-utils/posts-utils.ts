...
export const getPostWithPrefixIdToViewModel = (post: WithId<PostType>): PostViewModel => {
    return {id:post._id.toString(),blogId:post.blogId,title:post.title,blogName:post.blogName,shortDescription:post.shortDescription,content:post.content,createdAt:post.createdAt}
}
