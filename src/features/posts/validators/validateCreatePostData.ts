...
const schemaWithId = {...schema,   blogId: {
        custom: {
...
export const validateCreatePostDataWithIdParams = checkSchema(schemaWithId, ['body', 'query', "params"])
export const validateCreatePostData = checkSchema(schema, ['body', 'query', "params"])
