...
exports.validateCreatePostData = exports.validateCreatePostDataWithIdParams = void 0;
...
exports.validateCreatePostDataWithIdParams = (0, express_validator_1.checkSchema)(schemaWithId, [
    "body",
    "query",
    "params",
]);
exports.validateCreatePostData = (0, express_validator_1.checkSchema)(schema, [
    "body",
    "query",
    "params",
]);
