...
export const getAuthRouter = () => {
    ...
    router.post(
        ...
        async (
            ...
            res: Response<number | {errorMessages:string, field: string}[]>,
        ) => {
            ...
            if (result) {
                ...
                res.status(HTTP_STATUSES.BAD_REQUEST_400).send([{errorMessages:'user not found or code expired', field: 'code'}])
            }
        },
    );
