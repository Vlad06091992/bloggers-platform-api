...
describe("test for /blogs", () => {
        ...
        errorsMessages: [
          {
            field: "websiteUrl",
            message:
              "The 'websitUrl' field is required and must be no more than 100 characters.",
          },
        ],
      },
    );
        ...
        errorsMessages: [
          {
            field: "name",
            message:
              "The 'name' field is required and must be no more than 15 characters.",
          },
          {
            field: "description",
            message:
              "The 'description' field is required and must be no more than 500 characters.",
          },
        ],
      },
    );
      ...
      HTTP_STATUSES.BAD_REQUEST_400,
      {
        errorsMessages: [
          ...
          },
          {
            field: "description",
            message:
              "The 'short description' field is required and must be no more than 100 characters.",
          },
          {
            field: "websiteUrl",
            message:
  ...
  it("should be updated blog with correct data", async () => {
    ...
    let updatedBlog = await blogsTestManager.getBlogById(
      createdBlog.id,
      "Vlad",
