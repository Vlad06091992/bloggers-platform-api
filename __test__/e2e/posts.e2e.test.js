...
describe("test for /posts", () => {
    ...
    it("should return status 200 and empty", () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(app_1.app).get(app_1.Routes.videos).expect(http_statuses_1.HTTP_STATUSES.OK_200, []);
    }));
    ...
    it("should return status 200 and empty", () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(app_1.app).get(app_1.Routes.posts).expect(http_statuses_1.HTTP_STATUSES.OK_200, []);
    }));
});
